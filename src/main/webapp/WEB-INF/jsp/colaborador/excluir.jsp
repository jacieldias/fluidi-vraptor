			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
							<div id="msgSucesso">
		  		                 <p id="msgVaziaExcluir">Deseja realmente excluir o colaborador: ${colaborador.nome}?</p> 
		  	                </div>
					</div>
					<div class="modal-footer">
					        ...
					        <input type="hidden" class="form-control" id="txtVerificaConteudo">
			               	...
			               	<a href="${linkTo[ColaboradorController].remove(colaborador.id, colaborador.nome)}" class="btn btn-danger"><span class="glyphicon glyphicon glyphicon-ok"></span> Excluir</a>
